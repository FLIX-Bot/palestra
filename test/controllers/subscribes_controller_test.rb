...
class SubscribesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subscribe" do
    assert_difference('Subscribe.count') do
      post subscribes_url, params: { subscribe: { cellulare: @subscribe.cellulare, cognome: @subscribe.cognome, email: @subscribe.email, indirizzo: @subscribe.indirizzo, nome: @subscribe.nome } }
    end
  ...
  test "should update subscribe" do
    patch subscribe_url(@subscribe), params: { subscribe: { cellulare: @subscribe.cellulare, cognome: @subscribe.cognome, email: @subscribe.email, indirizzo: @subscribe.indirizzo, nome: @subscribe.nome } }
